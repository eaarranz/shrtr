...
public class AuthenticationController {
  ...
  public ValidateResponse validate(@RequestBody @Valid ValidateRequest request) {
    String tokenBearer = request.getToken();
    // Get jwt token and validate
    final String token = tokenBearer.split(" ")[1].trim();
    return ValidateResponse.of(jwtTokenUtil.validate(token));
  }
  ...
  public static class ValidateResponse {
    private boolean ok;
    public static ValidateResponse of(boolean value) {
      ValidateResponse validateResponse = new ValidateResponse();
      validateResponse.setOk(value);
